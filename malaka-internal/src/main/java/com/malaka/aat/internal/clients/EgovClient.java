...
import com.malaka.aat.internal.clients.gcp.EgovGcpRequest;
import com.malaka.aat.internal.clients.gcp.EgovGcpResponse;
...
public class EgovClient {
    ...
    public EgovGcpResponse getInfo(String pinpp) {
        ...
        String token = egovTokenClient.getToken();
